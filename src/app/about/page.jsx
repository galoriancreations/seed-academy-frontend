...
//       {/* Story Section */}
//       <section id="story" className="py-16 bg-gradient-to-r from-green-100 via-yellow-100 to-blue-100">
//         <div className="container mx-auto px-6">
//           <h2 className="text-3xl font-bold text-center mb-6 text-blue-700">Our Story</h2>
//           <p className="text-center text-gray-700 max-w-3xl mx-auto text-md leading-relaxed">
//             Ting Global’s SEED Academy was founded with a vision to transform the way we train young leaders.
//             We believe that effective leadership in the 21st century requires a new approach — one that is personalized,
//             technologically advanced, and emphasizes responsibility and ethical decision-making.
//           </p>
//           <p className="text-center text-gray-700 max-w-3xl mx-auto text-md leading-relaxed mt-6">
//             By collaborating with Living Cities Earth, we integrate holistic development strategies 
//             into our programs to ensure that our young leaders are equipped to foster thriving communities, 
//             while championing human well-being and environmental sustainability.
//           </p>
...
//               <h3 className="text-xl font-semibold text-blue-600">Dr. Alex Johnson</h3>
//               <p className="mt-4 text-gray-600">Founder & CEO</p>
//               <p className="text-gray-500">Expert in AI and leadership development.</p>
//             </div>
//             {/* Member 2 */}
//             <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
//               <h3 className="text-xl font-semibold text-blue-600">Emily Zhang</h3>
//               <p className="mt-4 text-gray-600">Head of Education</p>
//               <p className="text-gray-500">Passionate about personalized learning paths.</p>
//             </div>
//             {/* Member 3 */}
//             <div className="bg-white p-8 rounded-xl shadow-lg hover:shadow-xl transition-shadow">
//               <h3 className="text-xl font-semibold text-blue-600">Michael Lee</h3>
//               <p className="mt-4 text-gray-600">Community Manager</p>
//               <p className="text-gray-500">Building global connections for young leaders.</p>
//             </div>
//           </div>
//         </div>
//       </section>
  ...
  return (
    <main className="text-gray-900">
      ...
      <section
        ...
        style={{
          backgroundColor: '#f8fbff', // רקע אחיד, מאוד בהיר בגוון כחול-לבן
        }}
      >
        <div>
          <h2 className="text-3xl font-bold text-center mb-6 text-blue-600">Our Story</h2>
          <p className="text-center text-gray-700 max-w-3xl mx-auto text-md leading-relaxed">
            Ting Global’s SEED Academy was founded with a vision to transform the way we train young leaders.
            We believe that effective leadership in the 21st century requires a new approach — one that is personalized,
            technologically advanced, and emphasizes responsibility and ethical decision-making.
      ...
      <section className="py-20 bg-blue-100 text-center">
        <div className="container mx-auto px-6">
          <h2 className="text-4xl font-bold text-blue-700 mb-12">Meet the Team</h2>
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {/* Member 1 */}
            <div className="bg-white p-8 rounded-xl shadow-lg">
              <h3 className="text-xl font-semibold text-blue-600">Dr. Alex Johnson</h3>
